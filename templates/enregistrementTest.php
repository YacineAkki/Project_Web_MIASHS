...
<body>
	...
	<?php
			...
			function getCatIMC($idcategorie){
				...
				$conn =   new PDO('mysql:host=localhost;dbname=heathyYou;charset=utf8','root', '');
			...
			function CategorieIMC($imc){
				...
				$_SESSION['user']['besoinCal']=$QBC;
					...
					while ($resultat = $requete->fetch()){
						...
						echo  $resultat['Energie']."&nbsp;";
						echo 'kcal';
						echo"<br/>";
					}
					$requete = $bdd->query("SELECT * FROM platboisson WHERE nomGroupe = 'œufs' AND Energie BETWEEN $QBC*0.200 AND $QBC*0.220 ORDER BY idP ");
					while ($resultat = $requete->fetch()){
						echo  $resultat['nomPlat']."&nbsp; &nbsp; &nbsp;";
						echo  $resultat['Energie']."&nbsp;";
						echo 'kcal';
					...
					$requete = $bdd->query("SELECT * FROM platboisson WHERE nomGroupe = 'légumineuses' AND Energie BETWEEN $QBC*0.040 AND $QBC*0.050 ORDER BY idP");
					while ($resultat = $requete->fetch()){
						echo  $resultat['nomPlat']."&nbsp; &nbsp; &nbsp;";
						echo  $resultat['Energie']."&nbsp;";
						echo 'kcal';
					...
					$requete = $bdd->query("SELECT * FROM platboisson WHERE nomGroupe = 'viandes cuites' AND Energie BETWEEN $QBC*0.110 AND $QBC*0.120 ORDER BY idP");
					while ($resultat = $requete->fetch()){
						echo  $resultat['nomPlat']."&nbsp; &nbsp; &nbsp;";
						echo  $resultat['Energie']."&nbsp;";
						echo 'kcal';
					...
					$requete = $bdd->query("SELECT * FROM platboisson WHERE nomGroupe = 'charcuteries' AND Energie BETWEEN $QBC*0.110 AND $QBC*0.120 ORDER BY idP");
					while ($resultat = $requete->fetch()){
						echo  $resultat['nomPlat']."&nbsp; &nbsp; &nbsp;";
						echo  $resultat['Energie']."&nbsp;";
						echo 'kcal';
					...
					$requete = $bdd->query("SELECT * FROM platboisson WHERE nomGroupe = 'autres produits à base de viande' AND Energie BETWEEN $QBC*0.110 AND $QBC*0.120 ORDER BY idP");
					while ($resultat = $requete->fetch()){
						echo  $resultat['nomPlat']."&nbsp; &nbsp; &nbsp;";
						echo  $resultat['Energie']."&nbsp;";
						echo 'kcal';
					...
					$requete = $bdd->query("SELECT * FROM platboisson WHERE nomGroupe = 'pommes de terre et autres tubercules' AND Energie BETWEEN $QBC*0.060 AND $QBC*0.070 ORDER BY idP");
					while ($resultat = $requete->fetch()){
						echo  $resultat['nomPlat']."&nbsp; &nbsp; &nbsp;";
						echo  $resultat['Energie']."&nbsp;";
						echo 'kcal';
